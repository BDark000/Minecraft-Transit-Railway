...
/*
 for update
		register(TrainType.DRL_MINI, new ModelDRLMini(), "mtr:textures/entity/drl", "m_train", "s_train", 0xF287B7, "","",0,66, 0.5F, false);
		register(TrainType.E44_SMALL, new ModelE44Small(), "mtr:textures/entity/e44", "mlr", "m_train", 0xE7AF25, "mtr:textures/entity/m_train", "", 0, 93, 0.5F, true);
		register("drl", TrainType.DRL, new ModelDRL(), "mtr:textures/entity/drl", "m_train", "s_train", null, 0xF287B7, 66, 0.5F, false);
		register("k_train_tcl", TrainType.K_TRAIN_TCL, new ModelKTrain(true), "mtr:textures/entity/k_train_tcl", "k_train_lar", "k_train", null, 0x0EAB52, 81, 1, false);
		register("k_train_tcl_small", TrainType.K_TRAIN_TCL_SMALL, new ModelKTrainSmall(true), "mtr:textures/entity/k_train_tcl", "k_train_lar", "k_train", null, 0x0EAB52, 81, 1, false);
		register("k_train_tcl_mini", TrainType.K_TRAIN_TCL_MINI, new ModelKTrainMini(true), "mtr:textures/entity/k_train_tcl", "k_train_lar", "k_train", null, 0x0EAB52, 81, 1, false);
		register("k_train_ael", TrainType.K_TRAIN_AEL, new ModelKTrain(true), "mtr:textures/entity/k_train_ael", "k_train", "k_train_lar", null, 0x0EAB52, 81, 1, false);
		register("k_train_ael_small", TrainType.K_TRAIN_AEL_SMALL, new ModelKTrainSmall(true), "mtr:textures/entity/k_train_ael", "k_train_lar", "k_train", null, 0x0EAB52, 81, 1, false);
		register("k_train_ael_mini", TrainType.K_TRAIN_AEL_MINI, new ModelKTrainMini(true), "mtr:textures/entity/k_train_ael", "k_train_lar", "k_train", null, 0x0EAB52, 81, 1, false);
		...
		register("s_train", TrainType.S_TRAIN, new ModelSTrain(), "mtr:textures/entity/s_train", "s_train", "s_train", null, 0xC1CD23, 42, 0.5F, false);
		register("s_train_small", TrainType.S_TRAIN_SMALL, new ModelSTrainSmall(), "mtr:textures/entity/s_train", "s_train", "s_train", null, 0xC1CD23, 42, 0.5F, false);
		register("s_train_mini", TrainType.S_TRAIN_MINI, new ModelSTrainMini(), "mtr:textures/entity/s_train", "s_train", "s_train", null, 0xC1CD23, 42, 0.5F, false);
*/
		...
		register(TrainType.SP1900_TINY, new ModelSP1900Tiny(false), "mtr:textures/entity/sp1900", 0x003399, "mtr:textures/entity/sp1900", "", 5.5F, true, "sp1900", new JonTrainSound.JonTrainSoundConfig("sp1900", 120, 0.5F, false));
		...
		register(TrainType.C1141A, new ModelSP1900(true), "mtr:textures/entity/c1141a", 0xB42249, "mtr:textures/entity/sp1900", "", 8.5F, false, "c1141a", new JonTrainSound.JonTrainSoundConfig("c1141a", 96, 0.5F, false));
		register(TrainType.C1141A_SMALL, new ModelSP1900Small(true), "mtr:textures/entity/c1141a", 0xB42249, "mtr:textures/entity/sp1900", "", 6F, false, "c1141a", new JonTrainSound.JonTrainSoundConfig("c1141a", 96, 0.5F, false));
		register(TrainType.C1141A_TINY, new ModelSP1900Tiny(true), "mtr:textures/entity/c1141a", 0xB42249, "mtr:textures/entity/sp1900", "", 5.5F, true, "c1141a", new JonTrainSound.JonTrainSoundConfig("c1141a", 96, 0.5F, false));
		register(TrainType.C1141A_MINI, new ModelSP1900Mini(true), "mtr:textures/entity/c1141a", 0xB42249, "mtr:textures/entity/sp1900", "", 3F, true, "c1141a", new JonTrainSound.JonTrainSoundConfig("c1141a", 96, 0.5F, false));
		register(TrainType.M_TRAIN, new ModelMTrain(), "mtr:textures/entity/m_train", 0x999999, "mtr:textures/entity/m_train", "", 8.5F, false, "m_train", new JonTrainSound.JonTrainSoundConfig("m_train", 66, 0.5F, false));
		register(TrainType.M_TRAIN_SMALL, new ModelMTrainSmall(), "mtr:textures/entity/m_train", 0x999999, "mtr:textures/entity/m_train", "", 6F, false, "m_train", new JonTrainSound.JonTrainSoundConfig("m_train", 66, 0.5F, false));
		register(TrainType.M_TRAIN_MINI, new ModelMTrainMini(), "mtr:textures/entity/m_train", 0x999999, "mtr:textures/entity/m_train", "", 2.5F, true, "m_train", new JonTrainSound.JonTrainSoundConfig("m_train", 66, 0.5F, false));
		register(TrainType.CM_STOCK, new ModelCMStock(), "mtr:textures/entity/cm_stock", 0x999999, "mtr:textures/entity/m_train", "", 8.5F, false, "m_train", new JonTrainSound.JonTrainSoundConfig("m_train", 66, 0.5F, false));
		register(TrainType.CM_STOCK_SMALL, new ModelCMStockSmall(), "mtr:textures/entity/cm_stock", 0x999999, "mtr:textures/entity/m_train", "", 6F, false, "m_train", new JonTrainSound.JonTrainSoundConfig("m_train", 66, 0.5F, false));
		register(TrainType.CM_STOCK_MINI, new ModelCMStockMini(), "mtr:textures/entity/cm_stock", 0x999999, "mtr:textures/entity/m_train", "", 2.5F, true, "m_train", new JonTrainSound.JonTrainSoundConfig("m_train", 66, 0.5F, false));
		...
		register(TrainType.MLR_TINY, new ModelMLRTiny(), "mtr:textures/entity/mlr", 0x6CB5E2, "mtr:textures/entity/m_train", "mtr:textures/entity/mlr", 5.5F, true, "mlr", new JonTrainSound.JonTrainSoundConfig("mlr", 93, 0.5F, true));
		...
		register(TrainType.E44_SMALL, new ModelE44Small(), "mtr:textures/entity/e44", 0xE7AF25, "mtr:textures/entity/m_train", "", 5.5F, true, "mlr", new JonTrainSound.JonTrainSoundConfig("m_train", 93, 0.5F, true));
		...
		register(TrainType.R_TRAIN, new ModelRTrain(), "mtr:textures/entity/r_train", 0x6CB5E2, "mtr:textures/entity/sp1900", "mtr:textures/entity/mlr", 8.5F, false, "c1141a", new JonTrainSound.JonTrainSoundConfig("s_train", 96, 0.5F, false));
		register(TrainType.R_TRAIN_SMALL, new ModelRTrainSmall(), "mtr:textures/entity/r_train", 0x6CB5E2, "mtr:textures/entity/sp1900", "mtr:textures/entity/mlr", 6F, false, "c1141a", new JonTrainSound.JonTrainSoundConfig("s_train", 96, 0.5F, false));
		register(TrainType.R_TRAIN_MINI, new ModelRTrainMini(), "mtr:textures/entity/r_train", 0x6CB5E2, "mtr:textures/entity/sp1900", "mtr:textures/entity/mlr", 2.5F, true, "c1141a", new JonTrainSound.JonTrainSoundConfig("s_train", 96, 0.5F, false));
		register(TrainType.DRL, new ModelDRL(), "mtr:textures/entity/drl", 0xF287B7, "mtr:textures/entity/m_train", "", 8.5F, false, "m_train", new JonTrainSound.JonTrainSoundConfig("s_train", 66, 0.5F, false));
		register(TrainType.DRL_MINI, new ModelDRLMini(), "mtr:textures/entity/drl", 0xF287B7, "mtr:textures/entity/m_train", "", 5F, true, "m_train", new JonTrainSound.JonTrainSoundConfig("s_train", 66, 0.5F, false));
		...
		register(TrainType.K_TRAIN_TCL, new ModelKTrain(true), "mtr:textures/entity/k_train_tcl", 0x0EAB52, "mtr:textures/entity/k_train", "", 8.5F, false, "k_train_lar", new JonTrainSound.JonTrainSoundConfig("k_train", 75, 1, false));
		register(TrainType.K_TRAIN_TCL_SMALL, new ModelKTrainSmall(true), "mtr:textures/entity/k_train_tcl", 0x0EAB52, "mtr:textures/entity/k_train", "", 6F, false, "k_train_lar", new JonTrainSound.JonTrainSoundConfig("k_train", 75, 1, false));
		register(TrainType.K_TRAIN_TCL_MINI, new ModelKTrainMini(true), "mtr:textures/entity/k_train_tcl", 0x0EAB52, "mtr:textures/entity/k_train", "", 2.5F, true, "k_train_lar", new JonTrainSound.JonTrainSoundConfig("k_train", 75, 1, false));
		register(TrainType.K_TRAIN_AEL, new ModelKTrain(true), "mtr:textures/entity/k_train_ael", 0x0EAB52, "mtr:textures/entity/k_train", "", 8.5F, false, "k_train_lar", new JonTrainSound.JonTrainSoundConfig("k_train", 75, 1, false));
		register(TrainType.K_TRAIN_AEL_SMALL, new ModelKTrainSmall(true), "mtr:textures/entity/k_train_ael", 0x0EAB52, "mtr:textures/entity/k_train", "", 6F, false, "k_train_lar", new JonTrainSound.JonTrainSoundConfig("k_train", 75, 1, false));
		register(TrainType.K_TRAIN_AEL_MINI, new ModelKTrainMini(true), "mtr:textures/entity/k_train_ael", 0x0EAB52, "mtr:textures/entity/k_train", "", 2.5F, true, "k_train_lar", new JonTrainSound.JonTrainSoundConfig("k_train", 75, 1, false));
		register(TrainType.C_TRAIN, new ModelCTrain(), "mtr:textures/entity/c_train", 0xFDD900, "mtr:textures/entity/s_train", "", 8.5F, false, "c_train", new JonTrainSound.JonTrainSoundConfig("c_train", 69, 0.5F, false));
		register(TrainType.C_TRAIN_SMALL, new ModelCTrainSmall(), "mtr:textures/entity/c_train", 0xFDD900, "mtr:textures/entity/s_train", "", 6F, false, "c_train", new JonTrainSound.JonTrainSoundConfig("c_train", 69, 0.5F, false));
		register(TrainType.C_TRAIN_MINI, new ModelCTrainMini(), "mtr:textures/entity/c_train", 0xFDD900, "mtr:textures/entity/s_train", "", 2.5F, true, "c_train", new JonTrainSound.JonTrainSoundConfig("c_train", 69, 0.5F, false));
		register(TrainType.S_TRAIN, new ModelSTrain(), "mtr:textures/entity/s_train", 0xC1CD23, "mtr:textures/entity/s_train", "", 8.5F, false, "s_train", new JonTrainSound.JonTrainSoundConfig("s_train", 42, 0.5F, false));
		register(TrainType.S_TRAIN_SMALL, new ModelSTrainSmall(), "mtr:textures/entity/s_train", 0xC1CD23, "mtr:textures/entity/s_train", "", 6F, false, "s_train", new JonTrainSound.JonTrainSoundConfig("s_train", 42, 0.5F, false));
		register(TrainType.S_TRAIN_MINI, new ModelSTrainMini(), "mtr:textures/entity/s_train", 0xC1CD23, "mtr:textures/entity/s_train", "", 2.5F, true, "s_train", new JonTrainSound.JonTrainSoundConfig("s_train", 42, 0.5F, false));
