...
public enum RailType implements IGui {
	...
	OBSIDIAN(100, MaterialColor.COLOR_PURPLE, false, true, false, RailSlopeStyle.CURVE),
	BLAZE(130, MaterialColor.COLOR_ORANGE, false, true, false, RailSlopeStyle.CURVE),
